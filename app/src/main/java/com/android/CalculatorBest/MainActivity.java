...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private final static String keyCounters = "Calculate";
    ...
    private void initializeButton(){
        ...
        Button button_delete=findViewById(R.id.button_delite);
        ...
        Button button_multiply=findViewById(R.id.button_myltiply);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.button_plus:
                calculateData.plus(Double.parseDouble(editText.getText().toString()));
                editText.setText("");
                break;
            case R.id.button_minus:
                if (editText.getText().toString()!="") {
                    calculateData.minus(Double.parseDouble(editText.getText().toString()));
                    editText.setText("");
                }
                break;
            case R.id.button_divider:
                calculateData.divider(Double.parseDouble(editText.getText().toString()));
                editText.setText("");
                break;
            case R.id.button_myltiply:
                calculateData.multiply(Double.parseDouble(editText.getText().toString()));
                editText.setText("");
                break;
            case R.id.button_percent:
                calculateData.percent(Double.parseDouble(editText.getText().toString()));
                editText.setText("");
                break;
            case R.id.button_equals:
                editText.setText(""+ calculateData.getAnswer(Double.parseDouble(editText.getText().toString())));
                break;
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putSerializable(keyCounters, calculateData);
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        calculateData =(CalculateData)savedInstanceState.getSerializable(keyCounters);
